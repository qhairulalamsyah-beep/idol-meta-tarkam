...
interface QualifiedPlayersModalProps {
  isOpen: boolean;
...
export function QualifiedPlayersModal({
  isOpen,
  onOpenChange,
  players,
  division,
}: QualifiedPlayersModalProps) {
              ...
              <div className="flex items-center gap-3.5">
                ...
                <div className="flex-1 min-w-0">
                  <h2 className="text-lg font-bold text-white/90 tracking-tight">
                    Kualifikasi Grand Final
                  </h2>
                  <p className="text-[12px] text-white/45 mt-0.5">
                    12 pemain teratas lolos ke Grand Final
                  </p>
                </div>
              </div>
            </div>
            ...
            <div className="overflow-y-auto max-h-[calc(75vh-100px)] sm:max-h-[calc(80vh-100px)] p-4 space-y-2 scrollbar-thin">
              {players.length === 0 ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-sm text-white/40 font-medium">Belum ada pemain yang lolos</p>
                  <p className="text-xs text-white/30 mt-1">Mainkan turnamen mingguan untuk kualifikasi</p>
                </div>
              ) : (
                <>
                  {/* Top 3 podium mini */}
                  ...
                  {/* Qualified badge */}
                  <div
                    className="mt-4 rounded-xl p-3.5 text-center"
                    style={{
                      background: isMale
                  ...
                  >
                    <Star className={`w-4 h-4 mx-auto mb-1.5 ${accentColor}`} />
                    <p className="text-[11px] font-semibold text-white/70">
                      {players.length} pemain lolos ke Grand Final
                    </p>
                  </div>
                </>
              )}
